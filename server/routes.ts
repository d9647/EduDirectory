  ...
  app.get('/api/tutoring-providers', async (req, res) => {
    try {
      const filters = {
        ...
        type: req.query.type && req.query.type !== "all" ? req.query.type as string : undefined,
        city: req.query.city as string,
        state: req.query.state && req.query.state !== "all" ? req.query.state as string : undefined,
  ...
  app.get('/api/internships', async (req, res) => {
    try {
      const filters = {
        ...
        city: req.query.city as string,
        state: req.query.state as string,
        isRemote: req.query.isRemote === 'true' ? true : req.query.isRemote === 'false' ? false : req.query.isRemote === 'all' ? undefined : undefined,
        hasMentorship: req.query.hasMentorship === 'true' ? true : req.query.hasMentorship === 'false' ? false : req.query.hasMentorship === 'all' ? undefined : undefined,
        sortBy: req.query.sortBy as string,
        sortOrder: (req.query.sortOrder as "asc" | "desc") || "desc",
        limit: req.query.limit ? parseInt(req.query.limit as string) : 10,
        offset: req.query.offset ? parseInt(req.query.offset as string) : 0,
  ...
  app.get('/api/jobs', async (req, res) => {
    try {
      const filters = {
        ...
        isRemote: req.query.isRemote === 'true' ? true : req.query.isRemote === 'false' ? false : req.query.isRemote === 'all' ? undefined : undefined,
        minimumAge: req.query.minimumAge ? parseInt(req.query.minimumAge as string) : undefined,
        hasTraining: req.query.hasTraining === 'true' ? true : req.query.hasTraining === 'false' ? false : req.query.hasTraining === 'all' ? undefined : undefined,
        sortBy: req.query.sortBy as string,
        sortOrder: (req.query.sortOrder as "asc" | "desc") || "desc",
        limit: req.query.limit ? parseInt(req.query.limit as string) : 10,
        offset: req.query.offset ? parseInt(req.query.offset as string) : 0,
